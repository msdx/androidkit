/*
 * @(#)JsonHttpResponseHandler.java		       Project:androidkit
 * Date:2013-5-9
 *
...
public class JsonHttpResponseHandler extends AsyncHttpResponseHandler {
	...
	protected void sendSuccessMessage(int statusCode, Header[] headers, String responseBody) {
		if (statusCode != HttpStatus.SC_NO_CONTENT) {
			try {
				...
				sendMessage(obtainMessage(SUCCESS_JSON_MESSAGE, new Object[] { statusCode, headers,
						jsonResponse }));
			} catch (JSONException e) {
				sendFailureMessage(e, responseBody);
			}
		} else {
			sendMessage(obtainMessage(SUCCESS_JSON_MESSAGE, new Object[] { statusCode,
					new JSONObject() }));
		}
	}
	...
	protected void handleMessage(Message msg) {
		...
		case SUCCESS_JSON_MESSAGE:
			...
			handleSuccessJsonMessage(((Integer) response[0]).intValue(), (Header[]) response[1],
					response[2]);
			break;
		default:
