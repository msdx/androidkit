/*
 * @(#)UiBindDemo.java		       Project:androidkit.sample
 * Date:2013-6-7
 *
 ...
 */
package com.githang.androidkit.sample.uibind;
 ...
 *         /></a>
 */
public class UIBindDemo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sampleBeans.add(new SampleBean(UIBindSample.class));
